export const pages = [
  ...
  { name: "Insights", path: "/insights", heading: "財務インサイト" },
  {
    ...
    path: "/demo%3Ademo_group_001",
    heading: "ダッシュボード",
  },
  {
    name: "Group accounts",
    path: "/demo%3Ademo_group_001/accounts",
    heading: "連携サービス一覧",
  },
  {
    name: "Group account",
    path: "/demo%3Ademo_group_001/accounts/demo_000005",
    heading: "SBI証券",
  },
  { name: "Group balance sheet", path: "/demo%3Ademo_group_001/bs", heading: "資産" },
  { name: "Group cash flow", path: "/demo%3Ademo_group_001/cf", heading: "収支" },
  {
    name: "Group cash flow (monthly)",
    path: "/demo%3Ademo_group_001/cf/2025-12",
    heading: "収支 - 2025年12月",
  },
  {
    name: "Group insights",
    path: "/demo%3Ademo_group_001/insights",
    heading: "財務インサイト",
  },
  {
    name: "Group simulator",
    path: "/demo%3Ademo_group_001/simulator",
    heading: "シミュレーター",
  },
] as const;
